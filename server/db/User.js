...
const User = conn.define("user", {
  ...
  username: {
    ...
    validate: {
      notEmpty: {
        msg: "All users must have a username",
      },
    },
    unique: true,
  },
  ...
  email: {
    ...
    validate: {
      notEmpty: {
        msg: "All users must have an email address with their account",
      },
      isEmail: {
...
User.authenticateAsAdmin = async function ({ username, password }) {
  const user = await this.findOne({
    where: {
      username,
    },
